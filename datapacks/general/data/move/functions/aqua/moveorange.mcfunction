...
execute if score @e[tag=dummy,limit=1] zorange matches 1 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 38.875
execute if score @e[tag=dummy,limit=1] zorange matches 2 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 39.065
execute if score @e[tag=dummy,limit=1] zorange matches 3 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 39.255
execute if score @e[tag=dummy,limit=1] zorange matches 4 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 39.445
execute if score @e[tag=dummy,limit=1] zorange matches 5 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 39.635
execute if score @e[tag=dummy,limit=1] zorange matches 6 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 39.825
execute if score @e[tag=dummy,limit=1] zorange matches 7 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 40.015
execute if score @e[tag=dummy,limit=1] zorange matches 8 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 40.205
execute if score @e[tag=dummy,limit=1] zorange matches 9 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 40.395
execute if score @e[tag=dummy,limit=1] zorange matches 10 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 40.585
execute if score @e[tag=dummy,limit=1] zorange matches 11 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 40.775
