...
execute if score @e[tag=dummy,limit=1] xred matches 1 run execute as @e[tag=red_head1] at @s run tp @s 339.338 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 2 run execute as @e[tag=red_head1] at @s run tp @s 339.528 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 3 run execute as @e[tag=red_head1] at @s run tp @s 339.718 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 4 run execute as @e[tag=red_head1] at @s run tp @s 339.908 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 5 run execute as @e[tag=red_head1] at @s run tp @s 340.098 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 6 run execute as @e[tag=red_head1] at @s run tp @s 340.288 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 7 run execute as @e[tag=red_head1] at @s run tp @s 340.478 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 8 run execute as @e[tag=red_head1] at @s run tp @s 340.668 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 9 run execute as @e[tag=red_head1] at @s run tp @s 340.858 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 10 run execute as @e[tag=red_head1] at @s run tp @s 341.048 ~ ~
execute if score @e[tag=dummy,limit=1] xred matches 11 run execute as @e[tag=red_head1] at @s run tp @s 341.238 ~ ~
...
execute if score @e[tag=dummy,limit=1] zred matches 1 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 638.875
execute if score @e[tag=dummy,limit=1] zred matches 2 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 639.065
execute if score @e[tag=dummy,limit=1] zred matches 3 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 639.255
execute if score @e[tag=dummy,limit=1] zred matches 4 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 639.445
execute if score @e[tag=dummy,limit=1] zred matches 5 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 639.635
execute if score @e[tag=dummy,limit=1] zred matches 6 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 639.825
execute if score @e[tag=dummy,limit=1] zred matches 7 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 640.015
execute if score @e[tag=dummy,limit=1] zred matches 8 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 640.205
execute if score @e[tag=dummy,limit=1] zred matches 9 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 640.395
execute if score @e[tag=dummy,limit=1] zred matches 10 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 640.585
execute if score @e[tag=dummy,limit=1] zred matches 11 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 640.775
