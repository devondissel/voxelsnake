...
execute if score @e[tag=dummy,limit=1] xyellow matches 1 run execute as @e[tag=yellow_head1] at @s run tp @s 339.338 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 2 run execute as @e[tag=yellow_head1] at @s run tp @s 339.528 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 3 run execute as @e[tag=yellow_head1] at @s run tp @s 339.718 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 4 run execute as @e[tag=yellow_head1] at @s run tp @s 339.908 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 5 run execute as @e[tag=yellow_head1] at @s run tp @s 340.098 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 6 run execute as @e[tag=yellow_head1] at @s run tp @s 340.288 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 7 run execute as @e[tag=yellow_head1] at @s run tp @s 340.478 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 8 run execute as @e[tag=yellow_head1] at @s run tp @s 340.668 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 9 run execute as @e[tag=yellow_head1] at @s run tp @s 340.858 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 10 run execute as @e[tag=yellow_head1] at @s run tp @s 341.048 ~ ~
execute if score @e[tag=dummy,limit=1] xyellow matches 11 run execute as @e[tag=yellow_head1] at @s run tp @s 341.238 ~ ~
...
execute if score @e[tag=dummy,limit=1] zyellow matches 1 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 638.875
execute if score @e[tag=dummy,limit=1] zyellow matches 2 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 639.065
execute if score @e[tag=dummy,limit=1] zyellow matches 3 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 639.255
execute if score @e[tag=dummy,limit=1] zyellow matches 4 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 639.445
execute if score @e[tag=dummy,limit=1] zyellow matches 5 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 639.635
execute if score @e[tag=dummy,limit=1] zyellow matches 6 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 639.825
execute if score @e[tag=dummy,limit=1] zyellow matches 7 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 640.015
execute if score @e[tag=dummy,limit=1] zyellow matches 8 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 640.205
execute if score @e[tag=dummy,limit=1] zyellow matches 9 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 640.395
execute if score @e[tag=dummy,limit=1] zyellow matches 10 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 640.585
execute if score @e[tag=dummy,limit=1] zyellow matches 11 run execute as @e[tag=yellow_head1] at @s run tp @s ~ ~ 640.775
