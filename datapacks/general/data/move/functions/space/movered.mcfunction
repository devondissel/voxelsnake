...
execute if score @e[tag=dummy,limit=1] zred matches 1 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 238.875
execute if score @e[tag=dummy,limit=1] zred matches 2 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 239.065
execute if score @e[tag=dummy,limit=1] zred matches 3 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 239.255
execute if score @e[tag=dummy,limit=1] zred matches 4 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 239.445
execute if score @e[tag=dummy,limit=1] zred matches 5 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 239.635
execute if score @e[tag=dummy,limit=1] zred matches 6 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 239.825
execute if score @e[tag=dummy,limit=1] zred matches 7 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 240.015
execute if score @e[tag=dummy,limit=1] zred matches 8 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 240.205
execute if score @e[tag=dummy,limit=1] zred matches 9 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 240.395
execute if score @e[tag=dummy,limit=1] zred matches 10 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 240.585
execute if score @e[tag=dummy,limit=1] zred matches 11 run execute as @e[tag=red_head1] at @s run tp @s ~ ~ 240.775
