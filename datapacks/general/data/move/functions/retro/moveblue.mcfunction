...
execute if score @e[tag=dummy,limit=1] zblue matches 1 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 438.875
execute if score @e[tag=dummy,limit=1] zblue matches 2 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 439.065
execute if score @e[tag=dummy,limit=1] zblue matches 3 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 439.255
execute if score @e[tag=dummy,limit=1] zblue matches 4 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 439.445
execute if score @e[tag=dummy,limit=1] zblue matches 5 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 439.635
execute if score @e[tag=dummy,limit=1] zblue matches 6 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 439.825
execute if score @e[tag=dummy,limit=1] zblue matches 7 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 440.015
execute if score @e[tag=dummy,limit=1] zblue matches 8 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 440.205
execute if score @e[tag=dummy,limit=1] zblue matches 9 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 440.395
execute if score @e[tag=dummy,limit=1] zblue matches 10 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 440.585
execute if score @e[tag=dummy,limit=1] zblue matches 11 run execute as @e[tag=blue_head1] at @s run tp @s ~ ~ 440.775
...
execute if score @e[tag=dummy,limit=1] selectedmap matches 4 run function retro_running:blue