...
execute if score @e[tag=dummy,limit=1] xorange matches 1 run execute as @e[tag=orange_head1] at @s run tp @s 39.338 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 2 run execute as @e[tag=orange_head1] at @s run tp @s 39.528 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 3 run execute as @e[tag=orange_head1] at @s run tp @s 39.718 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 4 run execute as @e[tag=orange_head1] at @s run tp @s 39.908 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 5 run execute as @e[tag=orange_head1] at @s run tp @s 40.098 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 6 run execute as @e[tag=orange_head1] at @s run tp @s 40.288 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 7 run execute as @e[tag=orange_head1] at @s run tp @s 40.478 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 8 run execute as @e[tag=orange_head1] at @s run tp @s 40.668 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 9 run execute as @e[tag=orange_head1] at @s run tp @s 40.858 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 10 run execute as @e[tag=orange_head1] at @s run tp @s 41.048 ~ ~
execute if score @e[tag=dummy,limit=1] xorange matches 11 run execute as @e[tag=orange_head1] at @s run tp @s 41.238 ~ ~
...
execute if score @e[tag=dummy,limit=1] zorange matches 1 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 438.875
execute if score @e[tag=dummy,limit=1] zorange matches 2 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 439.065
execute if score @e[tag=dummy,limit=1] zorange matches 3 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 439.255
execute if score @e[tag=dummy,limit=1] zorange matches 4 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 439.445
execute if score @e[tag=dummy,limit=1] zorange matches 5 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 439.635
execute if score @e[tag=dummy,limit=1] zorange matches 6 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 439.825
execute if score @e[tag=dummy,limit=1] zorange matches 7 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 440.015
execute if score @e[tag=dummy,limit=1] zorange matches 8 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 440.205
execute if score @e[tag=dummy,limit=1] zorange matches 9 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 440.395
execute if score @e[tag=dummy,limit=1] zorange matches 10 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 440.585
execute if score @e[tag=dummy,limit=1] zorange matches 11 run execute as @e[tag=orange_head1] at @s run tp @s ~ ~ 440.775
...
execute if score @e[tag=dummy,limit=1] selectedmap matches 4 run function retro_running:orange