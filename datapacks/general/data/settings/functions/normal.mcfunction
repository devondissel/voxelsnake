...
scoreboard players set @e[tag=dummy] difficulty 2

title @a actionbar ["",{"text":"Difficulty has been set to normal.","color":"yellow"}]
...
data merge entity @e[tag=normal,limit=1] {CustomName:'{"text":"Normal","color":"yellow","underlined":true}'}
